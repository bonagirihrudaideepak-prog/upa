    ...
    <div className="fixed bottom-24 right-6 z-50">
      <div className="relative">
        ...
        <a
          ...
          className="flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-tr from-[#f09433] via-[#e6683c] via-[#dc2743] via-[#cc2366] via-[#bc1888] to-[#9423c2] text-white hover:opacity-90 transition-opacity"
