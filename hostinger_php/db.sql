...
CREATE DATABASE IF NOT EXISTS `upanishad_store` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `upanishad_store`;
...
(1, 'Electronics', 'electronics', 'Electronic devices and accessories', 1, 1),
(2, 'iPhone', 'iphone', 'Apple iPhone devices and covers', 2, 1),
(3, 'Samsung', 'samsung', 'Samsung smartphones and covers', 3, 1),
(4, 'Accessories', 'accessories', 'Covers, cases, tempered glass & protectors', 4, 1),
(5, 'Gadgets', 'gadgets', 'Smartwatches, earbuds & fast chargers', 5, 1),
(6, 'Others', 'others', 'Other electronic items & accessories', 6, 1)
ON DUPLICATE KEY UPDATE `id`=`id`;
